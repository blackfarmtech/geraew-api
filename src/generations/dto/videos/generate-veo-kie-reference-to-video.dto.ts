...
export class GenerateVeoKieReferenceToVideoDto {
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'Imagens de referência em base64 (1-3 imagens). Modo REFERENCE_2_VIDEO, apenas veo3_fast.',
    type: [String],
  })
  @IsArray()
  @ArrayMinSize(1)
  ...
  @ApiPropertyOptional({
    description: 'MIME types das imagens de referência',
    type: [String],
  })
  @IsOptional()
  @IsArray()
