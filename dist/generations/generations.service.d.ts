...
export declare class GenerationsService {
    ...
    constructor(prisma: PrismaService, creditsService: CreditsService, plansService: PlansService, uploadsService: UploadsService, geraewProvider: GeraewProvider, generationEvents: GenerationEventsService);
